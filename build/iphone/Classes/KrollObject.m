 ...
 * Copyright (c) 2009-2011 by FlexibleTask, Inc. All Rights Reserved.
...
//@interface FlexibleTaskObject : NSObject
//@end

@interface FlexibleTaskObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[FlexibleTaskObject class]])
		{
			for (NSString *key in [[(FlexibleTaskObject*)o modules] allKeys])
			{
