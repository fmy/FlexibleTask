...
@interface FlexibleTaskObject : KrollCoverageObject {
#else
@interface FlexibleTaskObject : KrollObject {
#endif
@private
...
extern NSString * FlexibleTask$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	FlexibleTaskObject *_flexibletask;
	BOOL shutdown;
