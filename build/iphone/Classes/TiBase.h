...
// in simulator we redefine to format for FlexibleTask Developer console
...
{\
	NSString * exceptionName = [@"org.flexibletask." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.flexibletask";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIFlexibleTaskNativeItemNone = -1, 
	UIFlexibleTaskNativeItemSpinner = -2,
	UIFlexibleTaskNativeItemProgressBar = -3,
	
	UIFlexibleTaskNativeItemSlider = -4,
	UIFlexibleTaskNativeItemSwitch = -5,
	UIFlexibleTaskNativeItemMultiButton = -6,
	UIFlexibleTaskNativeItemSegmented = -7,
	
	UIFlexibleTaskNativeItemTextView = -8,
	UIFlexibleTaskNativeItemTextField = -9,
	UIFlexibleTaskNativeItemSearchBar = -10,
	
	UIFlexibleTaskNativeItemPicker = -11,
	UIFlexibleTaskNativeItemDatePicker = -12,
	
	UIFlexibleTaskNativeItemInfoLight = -13,
	UIFlexibleTaskNativeItemInfoDark = -14,
	
	UIFlexibleTaskNativeItemDisclosure = -15,
	
	UIFlexibleTaskNativeItemContactAdd = -16
};
